...
namespace Character
{
	public class HorizontalBehavior: IFixedTickable, ITickable
	{
		...
		public HorizontalBehavior(Character character, [Inject("Main")] Camera camera)
		{
