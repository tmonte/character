...
//	public int numTypeParameters;
	...
	public List<MethodDefinition> CollectCandidates(List<TypeDefinitionBase> argumentTypes, Modifiers[] modifiers, Scope scope, ParseTree.Leaf invokedLeaf)
	{
	...
	public static MethodDefinition InferMethodTypeArguments(MethodDefinition method, List<TypeDefinitionBase> argumentTypes, ParseTree.Leaf invokedLeaf)
	{
	...
	public virtual MethodDefinition ResolveMethodOverloads(List<TypeDefinitionBase> argumentTypes, Modifiers[] modifiers, Scope scope, ParseTree.Leaf invokedLeaf)
	{
...
public class ConstructedMethodGroupDefinition : MethodGroupDefinition
{
	...
	public override MethodDefinition ResolveMethodOverloads(List<TypeDefinitionBase> argumentTypes, Modifiers[] modifiers, Scope scope, ParseTree.Leaf invokedLeaf)
	{
		...
		if (extensionsMethods.Count > 0)
		{
			...
			if (typeArgs == null)
			{
				for (var i = candidates.Count; i-- > 0; )
				{
					...
					candidate = MethodGroupDefinition.InferMethodTypeArguments(candidate, argumentTypes, invokedLeaf);
					if (candidate == null)
						candidates.RemoveAt(i);
					else
						candidates[i] = candidate;
